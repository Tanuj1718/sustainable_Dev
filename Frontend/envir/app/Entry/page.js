            ...
            <div className="w-full min-h-screen flex flex-col items-center space-y-10 px-4">
                ...
                <div className="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 rounded-lg w-full md:w-[70%] lg:w-[50%] min-h-screen mt-20 md:mt-10 flex flex-col items-center space-y-7 p-6">
                    ...
                    <div className="h-[200px] md:h-[250px] lg:h-[300px] rounded-3xl w-full md:w-[85%] bg-slate-200 flex flex-col space-y-4 justify-center items-center">
                        <Image onClick={changeParent}  className="h-[50px] md:h-[75px] lg:h-[100px] w-[50px] md:w-[75px] lg:w-[100px] hover:cursor-pointer" />
                        <h1 onClick={changeParent}  className="text-base md:text-lg lg:text-xl font-bold hover:cursor-pointer"> Drop your image here</h1>
                        <input ref={addImage} className="hidden" type="file" />
                    </div>
                    <div className="h-[200px] md:h-[250px] lg:h-[300px] rounded-3xl w-full md:w-[85%] bg-slate-200 flex flex-col space-y-4 justify-center items-center">
                        <Video  onClick={changeParent} className="h-[50px] md:h-[75px] lg:h-[100px] w-[50px] md:w-[75px] lg:w-[100px] hover:cursor-pointer"  />
                        <h1  onClick={changeParent}  className="text-base md:text-lg lg:text-xl font-bold hover:cursor-pointer" >  Drop your video here
                        </h1>
                        <input className="hidden" type="file" />
                    </div>
                    <button  className="rounded-xl transition-transform duration-300 hover:scale-105 bg-gradient-to-r from-purple-600 to-pink-600 p-2 w-full md:w-[85%] text-lg md:text-xl lg:text-2xl text-white font-bold">
                        Submit
                    </button>
                </div>
               </div>
